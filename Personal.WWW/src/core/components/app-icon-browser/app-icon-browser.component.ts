...
import { AppText } from "../../controls/app-text.component";
import { InputTextModule } from 'primeng/inputtext';
import { FormsModule } from '@angular/forms';

@Component({
    standalone: true,
    imports: [AppDialogComponent, AppText, InputTextModule, FormsModule],
    selector: 'app-icon-browser',
    templateUrl: 'app-icon-browser.component.html',
    styleUrl: 'app-icon-browser.component.scss'
})

export class AppIconBrowserComponent implements OnInit {
    constructor() { }
    ...
    getIcons() {
        return this.icons.filter(i => this.filter == '' || i.includes(this.filter));
    }
